...
-   Tracks were split into trips, defined as excursions \>`r params$colony_distance_km` km from the colony lasting \>`r params$duration_hr` hours.

-   Relocations within trips were re-discretized using linear interpolation at 2 min intervals.

-   Only trips with gaps ≤`r params$max_gaps` relocation`r ifelse(params$max_gaps == 1, "", "s")` were retained.
