...
-   Tracks were split into trips, defined as excursions \>10 km from the colony lasting \>2 hours.
...
Map of a trip with KPNWR for scale.
...
burst <- filter(tracks, burst == "1149_0054") %>% 
